...
public class CsrfFilter implements Filter {
     ...
     * không thể có mã. Chỗ này được bảo vệ bằng thứ khác: chữ ký của cổng thanh toán, và ràng
     * buộc duy nhất trên mã giao dịch để một lần gọi trùng không tính thành hai lần trả tiền.
     */
    private static final Set<String> EXEMPT_PATHS = Set.of("/payment/callback");
