...
public class UserDAO {
    ...
    public List<User> search(Connection con, String roleName, String keyword) throws SQLException {
        ...
        sql.append("ORDER BY r.role_id, u.full_name");
    ...
    public int insert(Connection con, User u) throws SQLException {
        String sql = "INSERT INTO dbo.Users (full_name, email, phone, password_hash, role_id, status, created_at) " +
                     "VALUES (?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement ps = con.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            JdbcSupport.setDateTime(ps, 7, u.getCreatedAt());
            ps.executeUpdate();
